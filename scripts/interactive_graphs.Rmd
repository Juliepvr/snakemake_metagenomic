...
setwd("C:/Users/- Julie -/Documents/BIT/Roslin stage/project")
#setwd("/exports/cmvm/eddie/eb/groups/watson_grp/julie_test_snakemake/pig_vs_chicken")

# Load the data
samples <- dir(path = "10_annotation/")

#protein <- dir(path = "." , recursive = TRUE, pattern="counts_protein")
...
# metadata
species <- c(replicate(5,"chicken"),replicate(5,"pig"))
...
# alpha = cutoff padj
res <- reactive({
  results(dds(), name="metadata_pig_vs_chicken", alpha=0.05, 
               contrast=c("metadata", "chicken", "pig")) 
  })
